...
class PyTorchCheckpoint:
    ...
    def restore(self, file_to_restore: str) -> None:
        ...
        # print(f"loaded_state {loaded_state}")
        print(f"loaded_state keys {loaded_state.keys()}")
        print(f"loaded_state['environment_name'] {loaded_state['environment_name']}")
        print(f"loaded_state['agent_name'] {loaded_state['agent_name']}")
